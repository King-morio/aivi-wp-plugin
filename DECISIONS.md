...
This file captures major product, runtime, and repository decisions that shape the current **AiVI - AI Visibility Inspector** plugin.

It exists so future work can understand **why** key choices were made, not just what the code currently does.
